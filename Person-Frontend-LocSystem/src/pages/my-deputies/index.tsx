      ...
      <header className="container mx-auto mb-3 flex items-center justify-between px-10 py-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Gerencie seus prepostos de acordo com o limite definido
          </p>
        </div>
        <div>
        ...
        <div className="space-y-4">
          ...
          <div className="overflow-auto rounded-lg border bg-background">
            <div className="sticky top-0 z-10 border-b bg-background">
              <div className="grid grid-cols-[minmax(200px,3fr)_minmax(200px,3fr)_minmax(120px,1fr)_minmax(120px,1fr)_80px] gap-4 p-4 font-medium text-muted-foreground text-sm">
                <div>Nome</div>
                <div>E-mail</div>
                <div>Telefone</div>
