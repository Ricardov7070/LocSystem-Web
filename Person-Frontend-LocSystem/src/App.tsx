      ...
      <Suspense fallback={<Loading />}>
        <Routes>
          ...
          <Route element={<AppLayout />}>
            ...
            <Route path="/users/advisory-users" element={<GuardedRoute path="/users/advisory-users" element={<AdvisoryUserDetailPage />} />} />
            ...
            <Route path="/legal-advisories" element={<GuardedRoute path="/legal-advisories" element={<LegalAdvisoryDetailPage />} />} />
